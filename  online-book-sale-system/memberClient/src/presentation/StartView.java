...
public class StartView extends JFrame {
	...
	public StartView() {
		...
		nameLabel.setFont(new Font("»ªÎÄÐÐ¿¬", Font.PLAIN, 17));
		...
		passwordLabel.setFont(new Font("»ªÎÄÐÐ¿¬", Font.PLAIN, 17));
		passwordLabel.setBounds(64, 129, 78, 33);
		contentPane.add(passwordLabel);
		
		final JButton logButton = new JButton("\u767B\u5F55");
		logButton.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 17));
		
		//logButtonµÄActionListener
		...
		registryButton.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 12));
