...
public class StartView extends JFrame {
	...
	public StartView() {
		...
		nameLabel.setBounds(96, 78, 78, 33);
		contentPane.add(nameLabel);
		
		nameField = new JTextField();
		nameField.setBounds(218, 75, 180, 36);
		...
		passwordLabel.setBounds(96, 129, 78, 33);
		...
		logButton.setBounds(96, 217, 117, 33);
		...
		cancelButton.setBounds(287, 217, 111, 33);
		contentPane.add(cancelButton);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(218, 128, 180, 33);
		...
		lblObss.setBounds(136, 25, 226, 33);
