...
public interface MemberBLService {
	...
	public ResultMessage addFavorities(BookPO bookPO ,MemberPO memberPO);//添加图书进入收藏夹
	public ResultMessage removeFavorities(BookPO bookPO,MemberPO memberPO);//从收藏夹中移除
	...
	public ResultMessage addOrder(OrderPO order,MemberPO memberPO);//增加一条订单记录
